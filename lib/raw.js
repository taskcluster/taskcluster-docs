...
module.exports = function() {
  ...
  const handleFile = async file => {
    ...
    if (docPath === 'README.md') {
      docPath = 'index.md';
    } else if (docPath.startsWith('references/') && !docPath.includes('logs')) {
                ...
                any: {
                  ...
                  read: (file, callback) => {
                    ...
                    if (u.hostname === 'schemas.taskcluster.net') {
                      ...
                      // e.g., https://taskcluster.example.com/schemas/hooks/v1/hook-definition.json
                      //   or  taskcluster:/schemas/hooks/v1/hook-definition.json (old, only supported for transition)
                      //   or  /schemas/hooks/v1/hook-definition.json
