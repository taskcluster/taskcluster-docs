...
(function(serverside, global, $, _, JSON) {
  ...
  // another search replace, I hope it works hack
  var col_class = 'col-sm-3';
  var col_control_class = 'col-sm-9';
...
jsonform.fieldTemplate = function(inner) {
  return '<div class="form-group jsonform-error-<%= keydash %>' +
    ...
    '<% if (node.title && !elt.notitle) { %>' +
      '<label class="control-label ' + col_class + '" for="<%= node.id %>"><%= node.title %></label>' +
    '<% } %>' +
    '<div class="controls ' + col_control_class + '">' +
...
var inputFieldTemplate = function (type) {
  return {
    'template': '<input class="form-control" type="' + type + '" ' +
    ...
    'template': '<fieldset class="tab-container <%= elt.htmlClass?elt.htmlClass:"" %>">' +
      ...
      '<div class="tabbable">' +
        '<div class="form-group<%= node.formElement.hideMenu ? " hide" : "" %>">' +
          '<% if (node.title && !elt.notitle) { %><label class="control-label ' + col_class + '" for="<%= node.id %>"><%= node.title %></label><% } %>' +
          '<div class="controls ' + col_control_class + '"><%= tabs %></div>' +
        '</div>' +
        '<div class="tab-content">' +
          '<%= children %>' +
        '</div>' +
...
formTree.prototype.buildFromLayout = function (formElement, context) {
  ...
  if (formElement.key) {
    ...
    // Honestly, I just searched for description and decide to convert from
    // markdown to HTML here - and it works. how lovely... :)
    formElement.description = marked(formElement.description);
