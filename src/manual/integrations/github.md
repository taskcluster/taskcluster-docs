...
to set `extra.github.env`.

*Note*, not all events will cause all environment variables to be populated.
For example, a push event does not involve a base repository.
